...
Motors_Robot import
All_motors import 
pin import 4 input-pin 5 input-pin 20 input-pin 21 input-pin 
InitAll 
...
All_motors import
four_sensors import 
: BlackStopZone  LEFTSIDESENSOR RIGHTSIDESENSOR  + 0<>  ; \ To stop the program.
: tiny-full InitAll begin LEFTSENSOR RIGHTSENSOR BOTH-OFF? if GOSTRAIGHT then   LEFTSENSOR turn RIGHTSENSOR turn  LEFTSIDESENSOR 0= if run_tiny-anticlockwise then RIGHTSIDESENSOR 0= if run_tiny-clockwise  then  BlackStopZone while repeat ;
: tiny>> 4000 ms  tiny-full four_sensors unimport ; \ launch the TinyRobot in a delayed time.
